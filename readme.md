...
4. **Configure the connection string** to your database using [User Secrets](https://learn.microsoft.com/en-us/aspnet/core/security/app-secrets).
5. **Initialize the database schema** by running the [database creation script](./.sql/database_creation_script.sql).

## Prerequisites

- [.NET 10 SDK](https://dotnet.microsoft.com/download/dotnet/10.0) must be installed.
